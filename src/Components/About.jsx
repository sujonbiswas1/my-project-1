        ...
        <div className="pt-60">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10  ">
            ...
            <div className="bg-[#20114f] outline-[#4719bc] relative py-10 mt-18 md:mt-0 px-6 rounded-2xl" >
              <img src="/src/assets/images/e1.png" className="shadow-lg absolute -top-28 -ml-5" alt="" />
              ...
              <div className="bg-[#20114f] outline-[#4719bc] relative py-10 mt-18 md:mt-0 px-6 rounded-2xl" >
              <img src="/src/assets/images/government.png" className="shadow-lg absolute -top-40 -ml-2" alt="" />
